...
def build_params(params):
    params["feature_tags_dict"] = {tag: i for i, tag in enumerate([
    ...
    params["INPUT_WORDS_CNT_LEFT"] = params["INPUT_WORDS_CNT"] // 2
    params["INPUT_WORDS_CNT_RIGHT"] = params["INPUT_WORDS_CNT"] - params["INPUT_WORDS_CNT_LEFT"]
