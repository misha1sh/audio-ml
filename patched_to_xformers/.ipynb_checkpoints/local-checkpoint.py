...
class LocalAttention(Attention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        print(type(self.attention_mask), type(q))
        if self.attention_mask is not None: print(self.attention_mask.is_sparse)
        ...
        print(type(self.attention_mask), self.attention_mask.is_sparse)
